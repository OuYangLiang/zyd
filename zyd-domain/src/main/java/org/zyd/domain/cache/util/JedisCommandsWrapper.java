...
public class JedisCommandsWrapper implements JedisCommands {
	
	private final static String delimitor = "_";
	private int splitMod;
	private JedisCommands commands;

	@Override
	public String set(String key, String value) {
		String nKey = key + delimitor + Math.abs(key.hashCode() % splitMod);
		return commands.set(nKey, value);
	}
	...
	public String set(String key, String value, String nxxx, String expx,
			long time) {
		String nKey = key + delimitor + Math.abs(key.hashCode() % splitMod);
		return commands.set(nKey, value, nxxx, expx, time);
	}
	...
	public Long hset(String key, String field, String value) {
		String nKey = key + delimitor + Math.abs(field.hashCode() % splitMod);
		
		return commands.hset(nKey, field, value);
	}
	...
	public void setSplitMod(int splitMod) {
		this.splitMod = splitMod;
	}

	public void setCommands(JedisCommands commands) {
